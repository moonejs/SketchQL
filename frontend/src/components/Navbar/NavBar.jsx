...
export default function NavBar(){
    ...
    return(
        <>
            ...
            <nav class="navbar navbar-dark text-white navbar-expand-lg main-primary-color pt-2 pb-1">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item ms-3 dropdown ">
                            <a class="nav-link dropdown-toggle canvas-nav-hover canvas-nav fw-bold px-3" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            File
                        ...
                        <ul class="dropdown-menu text-black">
                            <li>
                                <a class="dropdown-item" onClick={() => navigate('/dashboard')}>Dashboard</a>
                            </li>
                            <li>
                                <a class="dropdown-item" onClick={handleCreateNew}>New Diagram</a>
                            </li>
                            ...
                            <li>
                                <a class="dropdown-item" onClick={downloadImage}>Download as png
                            ...
                            <li>
                                <a class="dropdown-item" onClick={() => setShowModal(true)}>Exporte Code
                        ...
                        <li class="nav-item ms-3">
                            <a class="nav-link  canvas-nav-hover canvas-nav fw-bold px-3" href="#" role="button"  aria-current="page"
                            onClick={handleShare}
                            >
                            Share
                            </a>
                    ...
                    <div className="me-10 ">
                        <button class=" text-white  btn ai-glow-button d-flex align-items-center"
                        onClick={() => setShowAiModal(true)}>
